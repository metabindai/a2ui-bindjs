...
export const DASHBOARD_MESSAGES: AgentMessage[] = [
  { "version": "v1.0",
    "createSurface": {
      "surfaceId": "dashboard",
      "components": [
